...
const contractAddress = '0x2bc77b1606317DC944090c6317A27C423223D3f6';

/// getting contract
const web3 = new Web3(new Web3.providers.HttpProvider(targetApi));
const iconsTokenIco = web3.eth.contract(abi).at(contractAddress);

/// read and display values
writeValue('contractAddress', contractAddress);
writeValue('totalRaised', toEthString(iconsTokenIco.totalRaised()));

const startDate = hexSecondsToMillis(iconsTokenIco.startTimestamp());
const endDate = startDate + hexSecondsToMillis(iconsTokenIco.durationSeconds());
writeValue('startDate', new Date(startDate).toLocaleString());
writeValue('endDate', new Date(endDate).toLocaleString());

writeValue('minCap', toEthString(iconsTokenIco.minCap()));
writeValue('maxCap', toEthString(iconsTokenIco.maxCap()));